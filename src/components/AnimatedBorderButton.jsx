...
export const AnimatedBorderButton = () => {
  return (
    <a
      ...
      rel="noreferrer"
      download
      className="relative inline-flex items-center justify-center gap-2 bg-transparent border border-border text-foreground hover:border-primary/50 transition-all duration-1000 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 group px-8 py-4 text-lg rounded-full overflow-visible animated-border"
    >
      <svg
